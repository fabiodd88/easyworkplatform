					...
					<div class="panel-group ">
						<div class="panel panel-default ">
							<div class="container ">
								...
								<form id="newUserForm" style="text-align: center;" role="form" action="riepilogoDatiUtente.jsp" method="post">
  										...
  										<table class="table" >
											...
											<tr>
												<div class="form-group">
													...
													<th><input type="number" class="form-control" name="surename" required="vatCode"></th>
												</div>
											</tr>
											<tr>
												<div class="form-group">
													<th><label for="">Tipologia</label></th> 
													<th><input type="text" required="required" class="form-control" name="tipology"></th>
												</div>
											</tr>
											<tr>
												<div class="form-group">
													<th><label for="description size">Indirizzo</label></th>
													<th><input type="text" required="required" class="form-control" name="adress"></th>
												</div>
											</tr>
											<tr>
												<div class="form-group">
