					...
					<div class="panel-group ">
						<div class="panel panel-default ">
							<div class="container ">
								...
								<div
									style="float: right; margin-top: -80px; margin-right: 30px;">
									...
									<table class="table">
										<tr text-align="center">
											<td><a href="cliente.jsp"><img alt=""
													src="icon/cliente.png"></br>
													<button style="border: 0px; background: #FFFFFF" onclick="addCliente()">
														<img alt="" src="icon/add.png"></br>Aggiungi</button>
													<button style="border: 0px; background: #FFFFFF" onclick="modificaCliente(cliente)">
														<img alt="" src="icon/modifica.png"></br>Modifica</button>
													<button style="border: 0px; background: #FFFFFF" onclick="removeCliente(cliente)">
														<img alt="" src="icon/remove.png"></br>Elimina</button>
													<button style="border: 0px; background: #FFFFFF" onclick="searchCliente">
													<img alt="" src="icon/search.png"></br>Cerca</button>
											</td>
							...
							<form class="form" id="newCliente"
								style="text-align: center; display: none; border: 1px solid black; width: 100%"
