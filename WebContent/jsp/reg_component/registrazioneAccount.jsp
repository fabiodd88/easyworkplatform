							...
							<div class="vertical">
								...
								<div class="divHorizontal">
									<label style="width: 30%">Conferma password<span
										...
										class="form-control" pattern=".{6,8}"
										placeholder="Da 6 a 8 caratteri" />
								</div>
								<br>
								...
								<div class="divHorizontal">
									<label style="width: 30%">Chiave secondaria<span
										...
										type="password" name="secondKey" required class="form-control"
										pattern=".{6,8}" placeholder="Da 6 a 8 caratteri" />
								</div>
								<br>
								...
								<div class="divHorizontal">
									...
									</label> <input id="confSecondKey" type="password" name="confSecondKey"
										required class="form-control" pattern=".{6,8}"
										placeholder="Da 6 a 8 caratteri" />
								</div>
								<br>
