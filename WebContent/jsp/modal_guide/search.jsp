...
<div id="ricerca" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				<div class="table-responsive">
					<div class="vertical">
						<h1 class="text-center">Come ricercare un servizio</h1><br>
						<hr/>
						...
						<a>In alto a destra della tabella del servizio selezionato è presente il pulsante Filtri,</a>
